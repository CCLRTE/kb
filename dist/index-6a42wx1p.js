...
async function runPdfCapture(options, dependencies = {}) {
  ...
  const workspaceDirectory = options.workspaceDirectory ?? mkdtempSync2(join4(tmpdir(), "cclrte-info-pdf-"));
  try {
...
var remoteUserAgent = "CCLRTE-info/0.4 PDF capture";
...
async function preparePdfSource(input, options = {}, dependencies = {}) {
  ...
  const makeTemporaryDirectory = dependencies.makeTemporaryDirectory ?? (() => mkdtempSync3(join5(tmpdir2(), "cclrte-info-pdf-source-")));
