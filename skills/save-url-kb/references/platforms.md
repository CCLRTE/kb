...
| YouTube | HTTP + Defuddle, rendered browser, and yt-dlp for accessible media | Preserves page metadata, rendered transcript regions, and loaded comments when present | Unloaded comments and transcript or member regions outside the selected representation remain partial |
| Instagram, Facebook, LinkedIn, and TikTok | Current tab, rendered profile, or saved HTML; yt-dlp for accessible media | Preserves the loaded post, caption, and visible discussion context | Lazy loading, collapsed branches, and virtualization remain partial |
